...
\begin{document}
    ...
    \section{Experience}
        ...
        Feb 2022 – present
            ...
            \begin{highlights}
                \item Worked remotely leading development of an asset-centric data modeling approach for Databricks \& Delta Live Tables, enhancing data reliability and developer experience.
                \item Led an agile R\&D team to build real-time data ingestion pipelines handling massive volumes of CI-pipeline events using \textbf{\textit{Apache Flink (similar to AWS Kinesis) \& Spark Structured Streaming}}.
                \item Designed scalable data pipelines on \textbf{\textit{Databricks \& Snowflake, similar to AWS EMR \& AWSAWS  Redshift}}, enabling advanced analytics workloads.
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{HowIgotPwned}
            \begin{highlights}
                \item Developed a modern data lakehouse solution leveraging Apache Iceberg, Flink, Spark, Nessie \textbf{\textit{(similar to AWS Glue), MinIO (AWS S3 equivalent)}}, and Dagster to analyze high-volume data.
                \item Prototyped real-time ingestion pipelines using Apache Flink and Iceberg tables stored on Minio, Similar to AWS S3.
            \end{highlights}
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Designed and implemented an on-premise data lake solution for Kubernetes using Dagster, Nessie, Apache Iceberg, MinIO, Apache Flink and Spark. \textbf{\textit{Similar to AWS Glue, AWS S3 Tables and AWS S3}}.
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Data Catalogs:} Polaris, Snowflake, Unity \& Nessie \textbf{\textit{(Similar to AWS Glue)}}
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Big Data \& Streaming:} Apache Flink, Apache Spark, RabbitMQ
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Data Engineering Tools \& Platforms:} Databricks \& Delta Live Tables, Snowflake \textbf{\textit{(similar to AWS EMR \& Redshift)}}, dbt, dlthub, Dagster
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Cloud \& Platforms:} AWS, MinIO \& Azure Blob Storage (AWS S3 equivalent), Azure, Kubernetes, Proxmox
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Business Intelligence Tools:} PowerBI, Apache Superset, Lightdash, Streamlit
        \end{onecolentry}
