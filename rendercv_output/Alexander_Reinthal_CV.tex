...
\begin{document}
    ...
    \section{Alexander Reinthal}
        ...
        \begin{onecolentry}
            \textbf{\textit{Senior Data Platform Engineer, Independent Contributor \& Nix Advocate}} with expertise in building excellent reproducible environments from development to production. My Mission is to help build a safer future for the AI. Passionate about developer experience, mentoring engineers and Nix.
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Datalake Stack (My Personal Kubernetes Cluster)}
            \begin{highlights}
