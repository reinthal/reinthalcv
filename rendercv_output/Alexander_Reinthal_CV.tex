...
\begin{document}
    ...
    \section{Experience}
        ...
        Feb 2022 – present
            ...
            \begin{highlights}
                \item Led an agile R\&D team to build real-time data ingestion pipelines handling massive volumes of CI-pipeline logs using Apache Flink (AWS Kinesis/Data Streams equivalent) \& Spark Structured Streaming.
                \item Designed scalable data pipelines on Databricks \& Snowflake, equivalent to AWS Glue \& Athena, enabling advanced analytics workloads.
                ...
                \item Collaborated with stakeholders to refine data governance, enforce upstream data contracts, and improve real-time data visibility.
            \end{highlights}
        \end{twocolentry}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{HowIgotPwned}
            \begin{highlights}
                \item Developed a modern data lakehouse solution leveraging Apache Iceberg, Flink, Spark, Nessie, MinIO (AWS S3 equivalent), and Dagster to analyze high-volume data.
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Designed and implemented an on-premise data lake solution for Kubernetes using Nessie (Glue equivalent), Apache Iceberg, MinIO (AWS S3 equivalent), Apache Flink and Spark.
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Big Data \& Streaming:} Apache Flink, Apache Spark (AWS EMR equivalent), RabbitMQ, Kafka
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Cloud \& Platforms:} AWS (S3, Glue, ECS, EMR, Athena), MinIO (AWS S3 equivalent), Azure, Kubernetes, Proxmox
        \end{onecolentry}
