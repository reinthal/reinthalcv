...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Designed and implemented an on-premise data lake solution for Kubernetes using Dagster, Nessie, Apache Iceberg, MinIO, Apache Flink and Spark. Similar to AWS Glue, AWS S3 Tables  and AWS S3.
